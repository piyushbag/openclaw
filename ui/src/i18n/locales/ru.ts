...
export const ru: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Облачные обработчики требуют среду выполнения OpenClaw; выбрано {runtime}.",
  ...
  sessionsView: {
    ...
    sessionArchived: "Сессия заархивирована",
    sessionsArchived: "Заархивировано сессий: {count}",
    deleteAllArchived: "Удалить все архивные…",
    deleteAllArchivedConfirm: "Удалить {count} архивных сессий и их стенограммы?",
    ...
    dashboardAvailable: "Доступна панель управления",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Уведомления для OpenClaw отключены в macOS. Разрешите их в Системных настройках > Уведомления.",
    },
    appearance: {
      theme: "Тема",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Ваше руководство по настройке системы",
    exitSetup: "Выйти из настройки",
    hatchDraft: "Проснись, друг мой!",
    ...
    connectionChanged: "Соединение с Gateway изменилось. Повторите, чтобы продолжить настройку.",
    ...
    nudge: {
      ...
      channelDegraded: "{channel} работает с перебоями — спросите меня, что случилось",
  ...
  appsPage: {
    ...
    heroTagline:
      "Приложения-компаньоны для телефона, часов, компьютера и браузера — плюс плагины для расширения возможностей вашего агента.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Общайтесь в чате, говорите, подтверждайте действия и делитесь данными в OpenClaw из iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Быстрый просмотр чатов и быстрые ответы прямо с запястья.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      plugins: {
        ...
        desc: "Расширьте OpenClaw каналами, инструментами и Skills от сообщества.",
      },
    },
  },
  profilePage: {
  ...
  chat: {
    ...
    board: {
      faceLabel: "Лицо сессии",
      chatFace: "Чат",
      dashboardFace: "Панель",
      dockMenu: "Док чата: {dock}",
      ...
      mockPlaceholder: "Стык представления доски · вкладок: {tabs} · виджетов: {widgets}",
      mockOverview: "Обзор",
      mockResearch: "Исследование",
      mockSessionStatus: "Статус сессии",
    ...
    questions: {
      ...
      ownAnswer: "Ваш ответ…",
      ownAnswerFor: "Ваш ответ для {header}",
      submitting: "Отправка…",
    ...
    messages: {
      activity: "Активность",
      forkFromHere: "Разветвить отсюда",
      hide: "Скрыть",
      ...
      forkUnavailable: "Разветвление недоступно, пока агент работает",
    ...
    modelControls: {
      ...
      reasoning: "Рассуждение",
      speed: "Скорость",
      sessionOverride: "Переопределение для сессии",
