...
export const vi: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime: "Cloud worker yêu cầu runtime OpenClaw; {runtime} đã được chọn.",
  ...
  sessionsView: {
    ...
    dashboardAvailable: "Có sẵn bảng điều khiển",
  ...
  subtitles: {
    ...
    advanced: "Mọi phần cấu hình còn lại, cùng trình chỉnh sửa tập tin thô.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDegraded: "{channel} bị suy giảm — hãy hỏi tôi chuyện gì đã xảy ra",
  ...
  mcpPage: {
    connectorsLink: "Khám phá các trình kết nối một chạm trên trang Plugins.",
    servers: "Máy chủ",
    oauth: "OAuth",
    filtered: "Đã lọc",
  ...
  appsPage: {
    ...
    heroTagline:
      "Các ứng dụng đồng hành cho điện thoại, đồng hồ, máy tính và trình duyệt của bạn — cùng các plugin để mở rộng khả năng của tác nhân.",
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Ứng dụng đồng hành Android mở rộng OpenClaw lên đồng hồ của bạn.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Ứng dụng đồng hành Windows kết nối PC của bạn thành một node OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    label: "Bảng điều khiển phiên",
    tabsLabel: "Tab bảng điều khiển",
    moreTabs: "Thêm tab bảng điều khiển",
    gridLabel: "Widget bảng điều khiển",
    emptyTitle: "Một bảng trống, sẵn sàng làm việc",
    emptyHint: "Agent của bạn có thể ghim widget vào đây — thử yêu cầu một thẻ trạng thái.",
    ...
    announcement: {
      ...
      rejected: "Đã từ chối quyền truy cập widget.",
    },
    widget: {
      cellLabel:
      ...
      errorDetail: "Vấn đề chỉ giới hạn ở thẻ này.",
      actionErrorTitle: "Thay đổi widget thất bại",
      actionErrorDetail: "Bảng điều khiển đã giữ trạng thái widget trước đó.",
  ...
  chat: {
    ...
    board: {
      ...
      resizeDock: "Đổi kích thước neo trò chuyện",
      reopenChat: "Hiện trò chuyện",
      mockPlaceholder: "Đường nối chế độ xem bảng · {tabs} tab · {widgets} widget",
      mockOverview: "Tổng quan",
      mockResearch: "Nghiên cứu",
      mockSessionStatus: "Trạng thái phiên",
      mockRecentFindings: "Phát hiện gần đây",
      mockSourceMap: "Bản đồ nguồn",
      resetTitle: "Đặt lại cuộc trò chuyện?",
      resetDescription:
        "Ngữ cảnh cuộc trò chuyện sẽ đặt lại. Bảng điều khiển của bạn vẫn giữ nguyên.",
    },
    catalog: {
    ...
    messages: {
      ...
      rewind: "Tua lại",
      rewindConfirm: "Tua lại đến trước tin nhắn này?",
