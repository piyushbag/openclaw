...
export const pl: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Powiadomienia są wyłączone dla OpenClaw w macOS. Zezwól na nie w Ustawienia systemowe > Powiadomienia.",
    },
    appearance: {
      theme: "Motyw",
  ...
  subtitles: {
    ...
    advanced: "Wszystkie pozostałe sekcje konfiguracji oraz edytor pliku źródłowego.",
  ...
  custodian: {
    ...
    connectionChanged:
      "Połączenie z Gateway zmieniło się. Spróbuj ponownie, aby kontynuować konfigurację.",
    unsupportedGateway: "Zaktualizuj Gateway, aby kontynuować konfigurację z OpenClaw.",
    nudge: {
      configReload: "Ponowne wczytanie konfiguracji zatrzymane — zapytaj mnie, co się stało",
  ...
  mcpServers: {
    ...
    targetInvalid: "Wprowadź adres URL http(s) lub polecenie wiersza poleceń.",
  ...
  mcpPage: {
    connectorsLink: "Odkryj konektory jednym kliknięciem na stronie wtyczek.",
    servers: "Serwery",
    oauth: "OAuth",
    filtered: "Filtrowane",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Podglądowe czaty i szybkie odpowiedzi z nadgarstka.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Aplikacja towarzysząca dla Androida rozszerza OpenClaw na Twój zegarek.",
      },
      macos: {
        title: "macOS",
        desc: "Aplikacja w pasku menu dla Twojego Gateway — powiadomienia, zatwierdzenia, szybki czat.",
      },
      windows: {
        title: "Windows",
      ...
      chrome: {
        ...
        desc: "Pozwól OpenClaw sterować Twoim Chrome — kartami, stronami i formularzami.",
      },
      plugins: {
  ...
  board: {
    label: "Panel sesji",
    tabsLabel: "Karty panelu",
    moreTabs: "Więcej kart panelu",
    gridLabel: "Widżety panelu",
    emptyTitle: "Czysta tablica, gotowa do pracy",
    emptyHint: "Twój agent może tu przypinać widżety — poproś o kartę statusu.",
    actionFailed: "Nie udało się zapisać zmiany panelu.",
    actionInProgress: "Inna zmiana panelu jest jeszcze zapisywana.",
    announcement: {
      moved: "Przeniesiono {title}.",
      resized: "Zmieniono rozmiar {title}.",
      removed: "Usunięto {title}.",
      granted: "Dostęp widżetu dozwolony.",
      rejected: "Dostęp widżetu odrzucony.",
    },
    widget: {
      cellLabel:
        "Widget pulpitu: {title}. Użyj strzałek do nawigacji. Przytrzymaj Alt i naciśnij strzałkę, aby go przenieść.",
      moveHandle: "Przenieś {title}",
      resizeHandle: "Zmień rozmiar {title}",
      menuLabel: "Opcje widżetu",
      moveToTab: "Przenieś na kartę",
      ...
      allow: "Zezwól",
      reject: "Odrzuć",
      rejected: "Odrzucono dostęp",
      rejectedDetail: "Ten widżet pozostaje nieaktywny do czasu usunięcia lub zastąpienia.",
  ...
  chat: {
    ...
    board: {
      ...
      mockSessionStatus: "Status sesji",
      mockRecentFindings: "Ostatnie ustalenia",
      mockSourceMap: "Mapa źródeł",
      resetTitle: "Zresetować rozmowę?",
      resetDescription: "Kontekst rozmowy zostanie zresetowany. Twój pulpit pozostanie.",
    },
    catalog: {
    ...
    messages: {
      ...
      rewindConfirm: "Przewinąć do momentu przed tą wiadomością?",
      rewindToHere: "Przewiń do tego miejsca",
      rewindUnavailable: "Przewijanie wstecz jest niedostępne, gdy agent pracuje",
