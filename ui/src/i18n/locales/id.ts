...
export const id: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "Hapus {count} sesi yang diarsipkan beserta transkripnya?",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Notifikasi dinonaktifkan untuk OpenClaw di macOS. Izinkan di Pengaturan Sistem > Notifikasi.",
    },
    appearance: {
      theme: "Tema",
  ...
  subtitles: {
    ...
    custodian: "Pengaturan dan perawatan sistem.",
    ...
    advanced: "Semua bagian konfigurasi yang tersisa, plus editor file mentah.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Pendamping menu bar untuk Gateway Anda — notifikasi, persetujuan, obrolan cepat.",
      },
      windows: {
        title: "Windows",
  ...
  chat: {
    ...
    board: {
      faceLabel: "Wajah sesi",
      chatFace: "Obrolan",
      dashboardFace: "Dasbor",
      dockMenu: "Dok obrolan: {dock}",
      dockLeft: "Dok obrolan kiri",
      dockRight: "Dok obrolan kanan",
      dockBottom: "Dok obrolan bawah",
      dockHidden: "Sembunyikan obrolan",
      resizeDock: "Ubah ukuran dok obrolan",
      reopenChat: "Tampilkan obrolan",
      mockPlaceholder: "Sambungan tampilan papan · {tabs} tab · {widgets} widget",
      mockOverview: "Ikhtisar",
      mockResearch: "Riset",
      mockSessionStatus: "Status sesi",
      mockRecentFindings: "Temuan terbaru",
      mockSourceMap: "Peta sumber",
      resetTitle: "Atur ulang percakapan?",
      resetDescription: "Konteks percakapan diatur ulang. Dasbor Anda tetap ada.",
    },
    catalog: {
    ...
    messages: {
      activity: "Aktivitas",
      forkFromHere: "Cabangkan dari sini",
      hide: "Sembunyikan",
      hideConfirm: "Sembunyikan pesan ini di browser ini? Agen tetap dapat melihatnya.",
