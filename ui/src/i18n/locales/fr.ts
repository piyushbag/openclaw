...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    custodian: "Configuration et maintenance du système.",
  ...
  custodian: {
    ...
    placeholder: "Écrivez à OpenClaw…",
    sensitivePlaceholder: "Saisissez une valeur sensible…",
    ...
    nudge: {
      ...
      channelAuth:
        "L'authentification de {channel} s'est dégradée — demandez-moi ce qui s'est passé",
  ...
  mcpServers: {
    ...
    adminRequired: "Les modifications du serveur MCP nécessitent un accès operator.admin.",
    enable: "Activer",
    disable: "Désactiver",
  ...
  appsPage: {
    heroTitle: "Emmenez OpenClaw partout",
    heroTagline:
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats consultables d'un coup d'œil et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "L'application compagnon Windows connecte votre PC comme nœud OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    label: "Tableau de bord des sessions",
    tabsLabel: "Onglets du tableau de bord",
    moreTabs: "Plus d'onglets de tableau de bord",
    gridLabel: "Widgets du tableau de bord",
    emptyTitle: "Un tableau vide, prêt à l'emploi",
    emptyHint:
  ...
  chat: {
    ...
    board: {
      faceLabel: "Face de session",
      chatFace: "Chat",
      dashboardFace: "Tableau de bord",
      dockMenu: "Dock du chat : {dock}",
      ...
      resizeDock: "Redimensionner le dock du chat",
      reopenChat: "Afficher la discussion",
      mockPlaceholder: "Vue tableau · {tabs} onglets · {widgets} widgets",
      mockOverview: "Aperçu",
      mockResearch: "Recherche",
      mockSessionStatus: "État de la session",
    ...
    messages: {
      ...
      rewindUnavailable: "Le rembobinage est indisponible pendant que l'agent travaille",
