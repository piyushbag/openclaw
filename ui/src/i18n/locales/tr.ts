...
export const tr: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Henüz uygulamanız yok mu?",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Bulut işçileri OpenClaw çalışma zamanını gerektirir; {runtime} seçili.",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count} arşivlenen oturum ve dökümleri silinsin mi?",
    ...
    dashboardAvailable: "Kontrol paneli mevcut",
  ...
  configView: {
    ...
    syncedHint: "Gateway aracılığıyla cihazlarınız arasında senkronize edilir.",
    notifications: {
      ...
      nativeBlockedHint:
        "OpenClaw için bildirimler macOS'ta devre dışı. Sistem Ayarları > Bildirimler'den izin verin.",
    },
    appearance: {
      theme: "Tema",
  ...
  subtitles: {
    ...
    notifications: "Gateway'inizden gelen tarayıcı push bildirimleri.",
    security: "Gateway kimlik doğrulaması, exec politikası, araç profili ve onaylar.",
    advanced: "Kalan tüm yapılandırma bölümleri, ayrıca ham dosya düzenleyicisi.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} az önce bağlantısı kesildi — ne olduğunu bana sorun",
      channelDegraded: "{channel} bozuldu — ne olduğunu bana sorun",
  ...
  mcpPage: {
    connectorsLink: "Tek tıkla bağlanabilen konektörleri Plugins sayfasında keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Bileğinizden hızlıca görülebilen sohbetler ve hızlı yanıtlar.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      plugins: {
        ...
        desc: "OpenClaw'ı topluluktan gelen kanallar, araçlar ve becerilerle genişletin.",
      },
    },
  },
  profilePage: {
  ...
  board: {
    ...
    emptyTitle: "Temiz bir pano, çalışmaya hazır",
    ...
    widget: {
      cellLabel:
        "Pano widget'ı: {title}. Gezinmek için ok tuşlarını kullanın. Taşımak için Alt tuşunu basılı tutup bir ok tuşuna basın.",
      ...
      needsApprovalDetail: "Bu widget ek erişim istedi.",
      allow: "İzin ver",
      reject: "Reddet",
      ...
      actionErrorDetail: "Kontrol paneli önceki widget durumunu korudu.",
  ...
  chat: {
    ...
    board: {
      ...
      resizeDock: "Sohbet yuvasını yeniden boyutlandır",
      ...
      mockSessionStatus: "Oturum durumu",
      mockRecentFindings: "Son bulgular",
      mockSourceMap: "Kaynak haritası",
      resetTitle: "Konuşma sıfırlansın mı?",
      resetDescription: "Konuşma bağlamı sıfırlanır. Kontrol paneliniz kalır.",
    },
    catalog: {
