...
export const pt_BR: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "As notificações são exibidas nativamente pelo aplicativo OpenClaw neste Mac.",
  ...
  subtitles: {
    ...
    notifications: "Notificações push do navegador vindas do seu gateway.",
  ...
  custodian: {
    ...
    placeholder: "Envie uma mensagem para o OpenClaw…",
    sensitivePlaceholder: "Insira um valor sensível…",
    sensitiveReply: "Resposta sensível enviada",
    send: "Enviar",
    thinking: "O OpenClaw está pensando",
    requestFailed: "O OpenClaw não conseguiu responder. Tente novamente.",
    connectionChanged:
      "A conexão do Gateway mudou. Tente novamente para continuar esta configuração.",
    unsupportedGateway: "Atualize o Gateway para continuar a configuração com o OpenClaw.",
    nudge: {
      configReload: "A recarga da configuração parou — pergunte-me o que aconteceu",
      channelAuth: "A autenticação do {channel} degradou — pergunte-me o que aconteceu",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicativos complementares para o seu celular, relógio, desktop e navegador — além de plugins para ampliar o que o seu agente pode fazer.",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats rápidos e respostas ágeis direto do seu pulso.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "O companion do Android estende o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Companheiro na barra de menus do seu Gateway — notificações, aprovações, conversa rápida.",
      },
      windows: {
        title: "Windows",
      ...
      plugins: {
        ...
        desc: "Estenda o OpenClaw com canais, ferramentas e skills da comunidade.",
      },
    },
  },
  profilePage: {
  ...
  board: {
    ...
    emptyHint: "Seu agente pode fixar widgets aqui — experimente pedir um cartão de status.",
    ...
    widget: {
      ...
      errorDetail: "O problema está restrito a este cartão.",
      actionErrorTitle: "Falha ao alterar o widget",
  ...
  chat: {
    ...
    board: {
      faceLabel: "Face da sessão",
      chatFace: "Chat",
      dashboardFace: "Dashboard",
      dockMenu: "Dock do chat: {dock}",
      dockLeft: "Fixar chat à esquerda",
      dockRight: "Fixar chat à direita",
      dockBottom: "Fixar chat embaixo",
      dockHidden: "Ocultar chat",
      resizeDock: "Redimensionar dock do chat",
      reopenChat: "Mostrar chat",
      mockPlaceholder: "Seam da visualização do board · {tabs} abas · {widgets} widgets",
      mockOverview: "Visão geral",
      mockResearch: "Pesquisa",
      mockSessionStatus: "Status da sessão",
      mockRecentFindings: "Descobertas recentes",
      mockSourceMap: "Mapa de fontes",
      resetTitle: "Redefinir conversa?",
      resetDescription: "O contexto da conversa é redefinido. Seu dashboard permanece.",
    },
    catalog: {
    ...
    messages: {
      ...
      forkUnavailable: "A bifurcação não está disponível enquanto o agente está trabalhando",
