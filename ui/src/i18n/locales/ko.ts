...
export const ko: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "클라우드 워커에는 OpenClaw 런타임이 필요합니다. {runtime}이(가) 선택되었습니다.",
  ...
  sessionsView: {
    ...
    sessionState: "세션 상태",
    viewArchived: "보관됨 보기",
    sessionArchived: "세션이 보관됨",
    sessionsArchived: "세션 {count}개 보관됨",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "알림은 이 Mac의 OpenClaw 앱에서 네이티브로 표시됩니다.",
  ...
  subtitles: {
    ...
    notifications: "Gateway에서 보내는 브라우저 푸시 알림.",
    security: "Gateway 인증, exec 정책, 도구 프로필, 승인.",
  ...
  custodian: {
    ...
    exitSetup: "설정 종료",
    hatchDraft: "일어나요, 친구!",
    placeholder: "OpenClaw에게 메시지…",
    sensitivePlaceholder: "민감한 값 입력…",
    sensitiveReply: "민감한 답변이 전송되었습니다",
    send: "보내기",
    ...
    nudge: {
      configReload: "구성 다시 로드가 중단되었습니다 — 무슨 일인지 물어보세요",
      channelAuth: "{channel} 인증이 저하되었습니다 — 무슨 일인지 물어보세요",
      channelDisconnected: "{channel} 연결이 방금 끊어졌습니다 — 무슨 일인지 물어보세요",
      channelDegraded: "{channel} 상태가 저하되었습니다 — 무슨 일인지 물어보세요",
      channelFallback: "채널",
      dismiss: "이 업데이트 닫기",
    },
  },
  mcpServers: {
    ...
    adding: "추가 중…",
    nameLabel: "이름",
    targetLabel: "URL 또는 명령어",
    nameInvalid: "서버 이름에는 문자, 숫자, 점, 대시, 밑줄을 사용합니다.",
    targetInvalid: "http(s) URL 또는 명령줄을 입력하세요.",
    nameTaken: "“{name}”(이)라는 이름의 MCP 서버가 이미 존재합니다.",
    missing: "구성에서 MCP 서버 “{name}”을(를) 찾을 수 없습니다.",
    missingTransport: "전송 누락",
    addedSuccess: "MCP 서버 {name}을(를) 추가했습니다.",
    enabledSuccess: "MCP 서버 {name}을(를) 사용하도록 설정했습니다.",
    disabledSuccess: "MCP 서버 {name}을(를) 사용하지 않도록 설정했습니다.",
    removedSuccess: "MCP 서버 {name}을(를) 제거했습니다.",
    configUnavailable: "구성을 사용할 수 없습니다. 새로 고침한 후 다시 시도하세요.",
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 시계, 데스크톱, 브라우저용 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인까지.",
    sectionMobile: "휴대폰에서",
    sectionWatch: "손목에서",
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Android 컴패니언이 OpenClaw를 시계까지 확장합니다.",
      },
      macos: {
        title: "macOS",
        desc: "Gateway용 메뉴 막대 도우미 — 알림, 승인, 빠른 채팅.",
      },
      windows: {
        title: "Windows",
  ...
  board: {
    ...
    actionInProgress: "다른 대시보드 변경 사항이 아직 저장 중입니다.",
    announcement: {
      moved: "{title} 이동됨.",
      resized: "{title} 크기 조정됨.",
      removed: "{title} 제거됨.",
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동하세요. Alt 키를 누른 채 화살표 키를 누르면 위젯을 옮길 수 있습니다.",
      moveHandle: "{title} 이동",
      ...
      errorDetail: "이 문제는 이 카드에만 영향을 줍니다.",
  ...
  chat: {
    ...
    board: {
      ...
      reopenChat: "채팅 표시",
      mockPlaceholder: "보드 뷰 시임 · 탭 {tabs}개 · 위젯 {widgets}개",
      mockOverview: "개요",
      mockResearch: "리서치",
      mockSessionStatus: "세션 상태",
      mockRecentFindings: "최근 결과",
      mockSourceMap: "소스 맵",
    ...
    messages: {
      ...
      forkFromHere: "여기서 분기",
      hide: "숨기기",
      hideConfirm: "이 브라우저에서 이 메시지를 숨길까요? 에이전트는 여전히 볼 수 있습니다.",
      hideMessage: "메시지 숨기기",
      ...
      forkUnavailable: "에이전트가 작업 중일 때는 포크를 사용할 수 없습니다",
