...
export const de: TranslationMap = {
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway zwischen Ihren Geräten synchronisiert.",
    notifications: {
      title: "Push-Benachrichtigungen",
      nativeTitle: "Benachrichtigungen",
      hint: "Erhalte Browser-Push-Benachrichtigungen von deinem Gateway.",
      nativeHint: "Benachrichtigungen werden von der OpenClaw-App nativ auf diesem Mac angezeigt.",
      ...
      nativeBlockedHint:
        "Benachrichtigungen sind für OpenClaw in macOS deaktiviert. Erlauben Sie sie in Systemeinstellungen > Mitteilungen.",
    },
    appearance: {
      theme: "Design",
  ...
  subtitles: {
    ...
    apps: "Begleit-Apps für Telefon, Uhr, Desktop und Browser.",
    ...
    notifications: "Browser-Push-Benachrichtigungen von Ihrem Gateway.",
    security: "Gateway-Authentifizierung, Ausführungsrichtlinie, Tool-Profil und Genehmigungen.",
    advanced: "Alle verbleibenden Konfigurationsabschnitte sowie der Editor für Rohdateien.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Ihre Anleitung zur Systemeinrichtung",
    ...
    connectionChanged:
      "Die Gateway-Verbindung hat sich geändert. Wiederholen Sie, um diese Einrichtung fortzusetzen.",
    unsupportedGateway:
      "Aktualisieren Sie das Gateway, um die Einrichtung mit OpenClaw fortzusetzen.",
    nudge: {
      configReload: "Konfigurations-Neuladen gestoppt — fragen Sie mich, was passiert ist",
      channelAuth: "{channel}-Authentifizierung beeinträchtigt — fragen Sie mich, was passiert ist",
      channelDisconnected: "{channel} wurde gerade getrennt — fragen Sie mich, was passiert ist",
      channelDegraded: "{channel} ist beeinträchtigt — fragen Sie mich, was passiert ist",
      channelFallback: "Ein Kanal",
      dismiss: "Diese Aktualisierung verwerfen",
    },
  },
  mcpServers: {
    ...
    nameInvalid:
      "Servernamen bestehen aus Buchstaben, Zahlen, Punkten, Bindestrichen oder Unterstrichen.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatte, sprich, bestätige Aktionen und teile Inhalte von iOS in OpenClaw.",
      },
      android: {
        title: "Android",
        desc: "Dein Android-Handy als vollwertiger OpenClaw-Node — Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      windows: {
        title: "Windows",
        desc: "Der Windows-Begleiter verbindet deinen PC als OpenClaw-Node.",
      },
      linux: {
        title: "Linux",
      ...
      plugins: {
        ...
        desc: "Erweitere OpenClaw mit Channels, Tools und Skills aus der Community.",
      },
    },
  },
  profilePage: {
  ...
  board: {
    ...
    emptyHint: "Dein Agent kann hier Widgets anheften – frag zum Beispiel nach einer Statuskarte.",
    ...
    announcement: {
      ...
      resized: "{title} in der Größe angepasst.",
    ...
    widget: {
      ...
      moveToTab: "Zu Tab verschieben",
      noOtherTabs: "Keine weiteren Tabs",
      resize: "Größe ändern",
      remove: "Entfernen",
      ...
      errorDetail: "Das Problem betrifft nur diese Karte.",
  ...
  chat: {
    ...
    board: {
      ...
      mockSessionStatus: "Sitzungsstatus",
      mockRecentFindings: "Aktuelle Ergebnisse",
      mockSourceMap: "Quellenübersicht",
      resetTitle: "Konversation zurücksetzen?",
      resetDescription:
        "Der Konversationskontext wird zurückgesetzt. Ihr Dashboard bleibt erhalten.",
    },
    catalog: {
      remoteViewOnly:
    ...
    messages: {
      ...
      rewind: "Zurückspulen",
      rewindConfirm: "Zurück vor diese Nachricht springen?",
      rewindToHere: "Hierher zurückspringen",
      rewindUnavailable: "Zurückspringen ist nicht verfügbar, während der Agent arbeitet",
