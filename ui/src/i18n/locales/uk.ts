...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "Архівовано сесій: {count}",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Сповіщення для OpenClaw вимкнено в macOS. Дозвольте їх у Системні параметри > Сповіщення.",
    },
    appearance: {
      theme: "Тема",
  ...
  subtitles: {
    ...
    security: "Автентифікація Gateway, політика виконання, профіль інструментів і підтвердження.",
  ...
  custodian: {
    ...
    connectionChanged:
      "З’єднання з Gateway змінилося. Повторіть спробу, щоб продовжити налаштування.",
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} щойно від’єднався — запитайте мене, що сталося",
      channelDegraded: "{channel} працює з погіршенням — запитайте мене, що сталося",
  ...
  mcpServers: {
    ...
    nameInvalid: "Імена серверів використовують літери, цифри, крапки, дефіси або підкреслення.",
    targetInvalid: "Введіть http(s) URL або командний рядок.",
    nameTaken: "MCP-сервер з іменем «{name}» вже існує.",
  ...
  appsPage: {
    heroTitle: "Беріть OpenClaw усюди",
    heroTagline:
      "Супутні застосунки для телефона, годинника, комп’ютера й браузера — плюс плагіни, що розширюють можливості вашого агента.",
    ...
    badgeBundledIos: "Входить до складу застосунку iOS",
    badgeBundledAndroid: "Входить до складу застосунку Android",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся, говоріть, підтверджуйте дії та діліться в OpenClaw з iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкі чати та миттєві відповіді просто з зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android-компаньйон розширює OpenClaw на ваш годинник.",
      },
      macos: {
        title: "macOS",
      ...
      plugins: {
        ...
        desc: "Розширюйте OpenClaw за допомогою каналів, інструментів та навичок від спільноти.",
      },
    },
  },
  profilePage: {
  ...
  board: {
    ...
    emptyHint: "Ваш агент може закріпити віджети тут — спробуйте попросити картку стану.",
    actionFailed: "Не вдалося зберегти зміну панелі.",
    actionInProgress: "Інша зміна панелі ще зберігається.",
    announcement: {
      moved: "Переміщено {title}.",
      resized: "Змінено розмір {title}.",
      removed: "Видалено {title}.",
    ...
    widget: {
      ...
      actionErrorDetail: "Панель залишила попередній стан віджета.",
  ...
  chat: {
    ...
    messages: {
      ...
      hide: "Приховати",
      hideConfirm: "Приховати це повідомлення в цьому браузері? Агент його все одно бачить.",
      hideMessage: "Приховати повідомлення",
      hideTooltip: "Приховати лише в цьому браузері",
      openInCanvas: "Відкрити в полотні",
      rewind: "Відмотати",
      rewindConfirm: "Відмотати до моменту перед цим повідомленням?",
