...
export const ja_JP: TranslationMap = {
  ...
  sessionsView: {
    ...
    dashboardAvailable: "ダッシュボードが利用可能です",
  ...
  configView: {
    ...
    syncedHint: "Gateway を介してデバイス間で同期されます。",
    notifications: {
      title: "プッシュ通知",
      nativeTitle: "通知",
      ...
      nativeBlockedHint:
        "macOS で OpenClaw の通知が無効になっています。システム設定 > 通知 で許可してください。",
    },
    appearance: {
      theme: "テーマ",
  ...
  custodian: {
    ...
    sensitivePlaceholder: "機密情報の値を入力…",
    sensitiveReply: "機密情報の返信を送信しました",
    send: "送信",
    thinking: "OpenClaw が考えています",
    requestFailed: "OpenClaw が返信できませんでした。もう一度お試しください。",
    connectionChanged:
      "Gateway の接続が変更されました。このセットアップを続けるには再試行してください。",
    unsupportedGateway: "OpenClaw でセットアップを続けるには Gateway を更新してください。",
    nudge: {
      configReload: "設定の再読み込みが停止しました — 何が起きたか私に尋ねてください",
      channelAuth: "{channel} の認証が低下しました — 何が起きたか私に尋ねてください",
      channelDisconnected: "{channel} の接続が切断されました — 何が起きたか私に尋ねてください",
      channelDegraded: "{channel} が低下しています — 何が起きたか私に尋ねてください",
  ...
  mcpServers: {
    ...
    adminRequired: "MCP サーバーの変更には operator.admin 権限が必要です。",
    enable: "有効化：",
    disable: "無効にする",
  ...
  mcpPage: {
    connectorsLink: "ワンクリックコネクタは Plugins ページで見つけられます。",
    servers: "サーバー",
    oauth: "OAuth",
    filtered: "フィルター済み",
  ...
  appsPage: {
    ...
    heroTagline:
      "スマートフォン、ウォッチ、デスクトップ、ブラウザ向けのコンパニオンアプリ。さらに、エージェントの機能を拡張するプラグインも。",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "手首から一目でチャットを確認し、素早く返信できます。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "AndroidコンパニオンがOpenClawを時計に拡張します。",
      },
      macos: {
        title: "macOS",
        desc: "Gateway向けのメニューバーコンパニオン — 通知、承認、クイックチャット。",
      },
      windows: {
        title: "Windows",
        desc: "Windows コンパニオンは、PC を OpenClaw ノードとして接続します。",
      },
      linux: {
        title: "Linux",
      ...
      plugins: {
        ...
        desc: "コミュニティのチャンネル、ツール、Skills で OpenClaw を拡張しましょう。",
      },
    },
  },
  profilePage: {
  ...
  board: {
    ...
    emptyTitle: "作業の準備が整った、すっきりしたボード",
    emptyHint:
    ...
    widget: {
      cellLabel:
        "ダッシュボードウィジェット: {title}。矢印キーで移動します。Altを押しながら矢印キーを押すと移動できます。",
      ...
      actionErrorDetail: "ダッシュボードは以前のウィジェットの状態を保持しました。",
      errorShow: "詳細を表示",
      kindMcp: "MCP",
      kindHtml: "HTML",
    },
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "チャットを左にドッキング",
      dockRight: "チャットを右にドッキング",
      dockBottom: "チャットを下にドッキング",
      dockHidden: "チャットを非表示",
      ...
      mockOverview: "概要",
      mockResearch: "リサーチ",
      mockSessionStatus: "セッションステータス",
      mockRecentFindings: "最近の発見",
    ...
    messages: {
      ...
      hide: "非表示",
      hideConfirm:
        "このブラウザでこのメッセージを非表示にしますか？エージェントには引き続き表示されます。",
      ...
      forkUnavailable: "エージェントの作業中はフォークできません",
      unknownDate: "不明な日付",
      voiceNote: "ボイスメモ",
    },
    modelControls: {
