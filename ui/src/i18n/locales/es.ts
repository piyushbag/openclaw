...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    apps: "Apps complementarias para teléfono, reloj, escritorio y navegador.",
  ...
  custodian: {
    ...
    connectionChanged:
      "La conexión con el Gateway cambió. Reintenta para continuar con esta configuración.",
    unsupportedGateway: "Actualiza el Gateway para continuar la configuración con OpenClaw.",
    nudge: {
      configReload: "Se detuvo la recarga de la configuración: pregúntame qué pasó",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplicaciones complementarias para tu teléfono, reloj, escritorio y navegador, además de plugins para ampliar lo que puede hacer tu agente.",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Complemento en la barra de menús para tu Gateway: notificaciones, aprobaciones, chat rápido.",
      },
      windows: {
        title: "Windows",
      ...
      chrome: {
        ...
        desc: "Deja que OpenClaw controle tu Chrome actual: pestañas, páginas y formularios.",
      },
      plugins: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget del panel: {title}. Usa las teclas de flecha para navegar. Mantén pulsado Alt y presiona una tecla de flecha para moverlo.",
  ...
  chat: {
    ...
    board: {
      faceLabel: "Cara de la sesión",
      chatFace: "Chat",
      dashboardFace: "Panel",
      dockMenu: "Panel de chat: {dock}",
      ...
      resizeDock: "Redimensionar el panel de chat",
      reopenChat: "Mostrar chat",
      mockPlaceholder: "Costura de vista de tablero · {tabs} pestañas · {widgets} widgets",
      mockOverview: "Descripción general",
      mockResearch: "Investigación",
      mockSessionStatus: "Estado de la sesión",
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "¿Ocultar este mensaje en este navegador? El agente lo seguirá viendo.",
      ...
      rewindUnavailable: "El rebobinado no está disponible mientras el agente está trabajando",
      forkUnavailable: "La bifurcación no está disponible mientras el agente está trabajando",
