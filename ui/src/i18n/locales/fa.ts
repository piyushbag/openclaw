...
export const fa: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count} نشست بایگانی‌شده و رونوشت‌هایشان حذف شوند؟",
  ...
  configView: {
    ...
    syncedHint: "از طریق gateway در همه دستگاه‌های شما همگام‌سازی می‌شود.",
    notifications: {
      ...
      nativeBlockedHint:
        "اعلان‌ها برای OpenClaw در macOS غیرفعال هستند. آن‌ها را در System Settings > Notifications مجاز کنید.",
    },
    appearance: {
      theme: "پوسته",
  ...
  subtitles: {
    ...
    advanced: "همه بخش‌های باقی‌مانده پیکربندی، به‌علاوه ویرایشگر فایل خام.",
  ...
  custodian: {
    ...
    nudge: {
      configReload: "بارگذاری مجدد پیکربندی متوقف شد — از من بپرس چه اتفاقی افتاد",
      channelAuth: "احراز هویت {channel} افت کرد — از من بپرس چه اتفاقی افتاد",
      channelDisconnected: "{channel} همین حالا قطع شد — از من بپرس چه اتفاقی افتاد",
      channelDegraded: "{channel} افت کرده است — از من بپرس چه اتفاقی افتاد",
      channelFallback: "یک کانال",
      dismiss: "بستن این به‌روزرسانی",
    },
  },
  mcpServers: {
    add: "افزودن سرور",
    ...
    nameLabel: "نام",
    targetLabel: "URL یا دستور",
    nameInvalid: "نام سرورها از حروف، اعداد، نقطه، خط تیره یا زیرخط استفاده می‌کنند.",
    targetInvalid: "یک نشانی http(s) یا یک خط فرمان وارد کنید.",
    ...
    configUnavailable: "پیکربندی در دسترس نیست؛ صفحه را تازه کنید و دوباره تلاش کنید.",
    connectRequired: "برای تغییر سرورهای MCP به Gateway متصل شوید.",
    adminRequired: "تغییر سرورهای MCP نیازمند دسترسی operator.admin است.",
    enable: "فعال‌سازی",
  ...
  mcpPage: {
    connectorsLink: "کانکتورهای یک‌کلیکی را در صفحه Plugins کشف کنید.",
    servers: "سرورها",
    oauth: "OAuth",
    filtered: "فیلترشده",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "از iOS گفت‌وگو کنید، صحبت کنید، اقدامات را تأیید کنید و در OpenClaw به اشتراک بگذارید.",
      },
      android: {
        title: "Android",
        desc: "گوشی Android شما به‌عنوان یک نود کامل OpenClaw — گفت‌وگو، دوربین و Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      macos: {
        title: "macOS",
        desc: "همراه نوار منو برای Gateway شما — اعلان‌ها، تأییدها و گفت‌وگوی سریع.",
      },
      windows: {
        title: "Windows",
        desc: "همیار Windows رایانه شما را به عنوان یک گره OpenClaw متصل می‌کند.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        title: "افزونه Chrome",
        desc: "به OpenClaw اجازه دهید Chrome موجود شما را هدایت کند — زبانه‌ها، صفحه‌ها و فرم‌ها.",
      },
      plugins: {
  ...
  board: {
    ...
    emptyHint: "عامل شما می‌تواند ویجت‌ها را اینجا سنجاق کند — کارت وضعیت را درخواست کنید.",
    actionFailed: "تغییر داشبورد ذخیره نشد.",
    actionInProgress: "تغییر دیگری در داشبورد هنوز در حال ذخیره است.",
    announcement: {
    ...
    widget: {
      cellLabel:
        "ابزارک داشبورد: {title}. برای پیمایش از کلیدهای جهت‌دار استفاده کنید. برای جابه‌جایی آن، Alt را نگه‌دارید و یک کلید جهت‌دار را فشار دهید.",
      moveHandle: "جابه‌جایی {title}",
      resizeHandle: "تغییر اندازه {title}",
      menuLabel: "گزینه‌های ابزارک",
      moveToTab: "انتقال به زبانه",
      noOtherTabs: "زبانه دیگری نیست",
      resize: "تغییر اندازه",
      remove: "حذف",
      needsApproval: "نیازمند تأیید",
      needsApprovalDetail: "این ابزارک درخواست دسترسی بیشتری کرده است.",
      allow: "اجازه دادن",
      reject: "رد کردن",
      rejected: "دسترسی رد شد",
      rejectedDetail: "این ابزارک تا زمانی که حذف یا جایگزین شود غیرفعال می‌ماند.",
      frameResolverMissing: "محتوای ابزارک در دسترس نیست.",
      errorTitle: "این ابزارک بارگذاری نشد",
      errorDetail: "این مشکل محدود به همین کارت است.",
      actionErrorTitle: "تغییر ابزارک ناموفق بود",
      actionErrorDetail: "داشبورد وضعیت قبلی ابزارک را حفظ کرد.",
  ...
  chat: {
    ...
    board: {
      ...
      dockMenu: "داک گفت‌وگو: {dock}",
      dockLeft: "داک گفت‌وگو در چپ",
      dockRight: "داک گفت‌وگو در راست",
      dockBottom: "داک گفت‌وگو در پایین",
      dockHidden: "پنهان کردن گفت‌وگو",
      resizeDock: "تغییر اندازه داک گفت‌وگو",
      reopenChat: "نمایش گفت‌وگو",
      mockPlaceholder: "درز نمای برد · {tabs} زبانه · {widgets} ویجت",
      mockOverview: "نمای کلی",
      mockResearch: "پژوهش",
      mockSessionStatus: "وضعیت جلسه",
      mockRecentFindings: "یافته‌های اخیر",
      mockSourceMap: "نقشه منبع",
      resetTitle: "بازنشانی گفت‌وگو؟",
      resetDescription: "زمینه گفت‌وگو بازنشانی می‌شود. داشبورد شما باقی می‌ماند.",
    },
    catalog: {
    ...
    messages: {
      ...
      rewind: "بازگردانی",
      rewindConfirm: "به قبل از این پیام بازگردانی شود؟",
      rewindToHere: "بازگردانی به اینجا",
      rewindUnavailable: "بازگردانی هنگام کار کردن عامل در دسترس نیست",
    ...
    composer: {
      ...
      takePhoto: "عکس گرفتن",
      cameraAccessFailed: "دسترسی به دوربین امکان‌پذیر نیست.",
