...
export const nl: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Meldingen worden op deze Mac native weergegeven door de OpenClaw-app.",
  ...
  subtitles: {
    ...
    custodian: "Systeeminstelling en onderhoud.",
    ...
    notifications: "Browserpushmeldingen vanaf je gateway.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Je gids voor systeeminstallatie",
    exitSetup: "Installatie afsluiten",
    hatchDraft: "Word wakker, vriend!",
    ...
    nudge: {
      configReload: "Herladen van configuratie gestopt — vraag me wat er gebeurd is",
      channelAuth: "Authenticatie van {channel} verslechterd — vraag me wat er gebeurd is",
      channelDisconnected: "{channel} is zojuist ontkoppeld — vraag me wat er gebeurd is",
      channelDegraded: "{channel} is verslechterd — vraag me wat er gebeurd is",
  ...
  mcpServers: {
    ...
    adminRequired: "Voor wijzigingen aan MCP-servers is operator.admin-toegang vereist.",
    enable: "Inschakelen",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chat, praat, keur acties goed en deel met OpenClaw vanaf iOS.",
      },
      android: {
        title: "Android",
      ...
      windows: {
        title: "Windows",
        desc: "De Windows-companion verbindt je pc als OpenClaw-node.",
      },
      linux: {
        title: "Linux",
  ...
  board: {
    ...
    announcement: {
      ...
      resized: "Formaat van {title} gewijzigd.",
    ...
    widget: {
      ...
      resizeHandle: "Formaat van {title} wijzigen",
      ...
      rejectedDetail: "Deze widget blijft inactief totdat hij wordt verwijderd of vervangen.",
  ...
  chat: {
    ...
    board: {
      ...
      mockPlaceholder: "Board-weergave naad · {tabs} tabbladen · {widgets} widgets",
      mockOverview: "Overzicht",
      mockResearch: "Onderzoek",
      mockSessionStatus: "Sessiestatus",
      mockRecentFindings: "Recente bevindingen",
      mockSourceMap: "Bronnenkaart",
    ...
    messages: {
      activity: "Activiteit",
      forkFromHere: "Vanaf hier splitsen",
      hide: "Verbergen",
      ...
      forkUnavailable: "Splitsen is niet beschikbaar terwijl de agent bezig is",
    ...
    modelControls: {
      ...
      reasoning: "Redenering",
      speed: "Snelheid",
      sessionOverride: "Sessie-overschrijving",
